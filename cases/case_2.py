...
def designed(file_parent_path, temp_parent_path, save_parent_path):
    ...
    t0950 = StructureImage(structure_path=[file_parent_path + "T0950.pdb", file_parent_path + "Predict.pdb"])
    ...
    t0950.set_hidden(hidden_contents=["model:Predict"])
    ...
    predict = StructureImage(structure_path=[file_parent_path + "T0950.pdb", file_parent_path + "Predict.pdb"])
    ...
    predict.set_hidden(hidden_contents=["model:T0950"])
    ...
    structure = StructureImage(structure_path=[file_parent_path + "T0950.pdb", file_parent_path + "Predict.pdb"])

from molpub.layouts import DefaultStructureImage, HighlightStructureImage, PropertyStructureImage, Figure
...
def designed(file_parent_path, temp_parent_path, save_parent_path):
    ...
    t0950.set_state(rotate=[90, 180, 0], inner_align=True, target="T0950")
    ...
    predict.set_state(rotate=[90, 180, 0], inner_align=True, target="T0950")
    ...
    structure = PropertyStructureImage(structure_paths=[file_parent_path + "T0950.pdb",
                                                        file_parent_path + "Predict.pdb"])
    structure.set_state(rotate=[90, 180, 0], inner_align=True, target="T0950")

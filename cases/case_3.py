from mola.layouts import StructureImage
...
def designed(file_parent_path, save_parent_path):
    ...
    structure = StructureImage(structure_path=[file_parent_path + "7QQA.pdb", file_parent_path + "Predict.pdb"])
    ...
    structure.set_hidden(hidden_contents=["residue:HOH", "residue:ADP", "residue:MG", "residue:SF4",
    ...
    structure.set_hidden(hidden_contents=["model:7QQA"])

...
def designed(file_parent_path, temp_parent_path, save_parent_path):
    ...
    gpr110gq = DefaultStructureImage(structure_path=[file_parent_path + "GPR110Gq.pdb"])
    ...
    gpr110gs = DefaultStructureImage(structure_path=[file_parent_path + "GPR110Gs.pdb"])
    ...
    gpr110g12 = DefaultStructureImage(structure_path=[file_parent_path + "GPR110G12.pdb"])
    ...
    gpr110g13 = DefaultStructureImage(structure_path=[file_parent_path + "GPR110G13.pdb"])
    ...
    gpr110gi = DefaultStructureImage(structure_path=[file_parent_path + "GPR110Gi.pdb"])

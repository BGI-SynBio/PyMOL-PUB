...
class ImageWindow1(object):
    def setupUi(self, Form):
        ...
        Form.resize(800, 600)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icon/logo.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
class ImageWindow3(object):
    def setupUi(self, Form):
        ...
        Form.resize(800, 600)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../icon/logo.pnsvgg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Form.setWindowIcon(icon)
        self.graphicsView = QtWidgets.QGraphicsView(Form)
        self.graphicsView.setGeometry(QtCore.QRect(40, 90, 491, 481))
        self.graphicsView.setObjectName("graphicsView")
